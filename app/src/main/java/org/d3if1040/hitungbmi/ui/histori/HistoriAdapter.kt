...
import org.d3if1040.hitungbmi.data.HitungBmi
import org.d3if1040.hitungbmi.databinding.ItemHistoriBinding
import org.d3if1040.hitungbmi.db.BmiEntity
...
class HistoriAdapter : RecyclerView.Adapter<HistoriAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: ItemHistoriBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(item: BmiEntity) = with(binding) {
            ...
            val stringRes = if (item.isMale) R.string.gender_pria else R.string.gender_wanita
